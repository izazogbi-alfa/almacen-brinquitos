...
6. Mientras capturas, sale **Sesión abierta**. A los **10 minutos sin capturar** se cierra sola (quién y cuándo), **Hoy** y el PDF de esa ventana se congelan, y aparece *Sesión cerrada por inactividad*. Si esa captura tenía trabajo, queda **pendiente**: el botón ámbar grande **Seguir existencias pendientes** (debajo de la fecha) reabre **la misma** sesión. Entrar otra vez *sin* ese botón abre una sesión nueva. No se bloquea hasta mañana. No hay botón de *Cerrar el día*.
...
Misma captura y misma tabla (varias prendas del mismo esquema, un PDF), título **Entrada de mercancía**, color verde. El PDF es de **esta sesión** (se cierra sola a los 10 minutos sin capturar; si quedó a medias, **Seguir recepción pendiente**). Carta horizontal, tallas en una fila, mismos colores de PDF.

## Pedidos

Misma captura y misma tabla si el módulo está marcado: varias prendas del mismo esquema en **un** pedido y **un** PDF. Al guardar, el detalle y el PDF del folio agrupan por prenda (colores en filas, tallas en una fila, carta horizontal, mismos colores). Estado *Por autorizar* hasta que una administradora autoriza. La captura de pedido también usa sesión de 10 minutos; el pendiente se retoma con el botón ámbar **Seguir pedidos pendientes** (lista de Pedidos y pantalla Nuevo pedido).
